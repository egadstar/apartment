...
module Apartment
  module Database
    ...
    def self.postgresql_adapter(config)
      Apartment.use_schemas ?
        Adapters::PostgresqlJDBCSchemaAdapter.new(config) :
        Adapters::PostgresqlJDBCAdapter.new(config)
    end
  end
  ...
  module Adapters
    ...
    class PostgresqlJDBCAdapter < AbstractJDBCAdapter

    end

    # Separate Adapter for Postgresql when using schemas
    class PostgresqlJDBCSchemaAdapter < AbstractJDBCAdapter
